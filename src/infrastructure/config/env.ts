...
export const envSchema = z.object({
	...
	YUZU_PROVISION_CONCURRENCY: z.coerce.number().int().positive().default(5),
	YUZU_DEPROVISION_CONCURRENCY: z.coerce.number().int().positive().default(5),
	YUZU_TOGGLE_STATUS_CONCURRENCY: z.coerce.number().int().positive().default(10),
	YUZU_RESOURCE_LOCK_TTL_MILLIS: z.coerce.number().int().positive().default(900000),
	YUZU_RESOURCE_LOCK_ACQUIRE_TIMEOUT_MILLIS: z.coerce.number().int().positive().default(30000),
	YUZU_RESOURCE_LOCK_RETRY_INTERVAL_MILLIS: z.coerce.number().int().positive().default(250),
